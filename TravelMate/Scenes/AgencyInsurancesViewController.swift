...
class AgencyInsurancesViewController: UIViewController {
    ...
    private func setupUI() {
        ...
        let ratingsButton = UIBarButtonItem(image: UIImage(systemName: "star.fill"), style: .plain, target: self, action: #selector(showAllRatings))
        ...
        navigationItem.rightBarButtonItems = [addButton, ratingsButton]
        ...
        Task {
            do {
                ...
                await MainActor.run {
                    ...
                    self.displayError(message: "Erreur: \(error.localizedDescription)")
                }
            }
        }
    }
    ...
    @objc private func showAllRatings() {
        let ratingsVC = AgencyRatingsViewController()
